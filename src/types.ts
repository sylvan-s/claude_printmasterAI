...
export interface TriageResult {
  ...
  routingDecision: {
     ...
     *  deterministically by classifyTriageOutcome from this same TriageResult's structured
    ...
    /** Mechanically generated by classifyTriageOutcome from which rule fired and the field
