...
D. LIQUIDITY. The evidence block does not give you a threshold to apply; it gives you the VERDICT, on a line reading "MEASURED SIGNAL: YES" or "MEASURED SIGNAL: NO". Obey that line. On YES, hold the lowEstimate at or below the anchor and name the sell-through as the reason. On NO, take no liquidity adjustment at all — not a small one, not a hedge. Quoting the rule and then discounting anyway is the specific failure this line exists to stop.
