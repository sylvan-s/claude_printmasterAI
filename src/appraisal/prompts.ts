...
- kWork title check: whenever you have an observed title (VEA text, Stage 1b, or the appraiser), call query_ackg with the workTitle parameter set to that title (a short distinctive fragment works best — "Death of the Virgin", not "The Death of the Virgin, first state"). The result tells you which artist(s), if any, the graph catalogues a work by that title to. If exactly one artist comes back, record kWorkBackPropArtist = that artist and kWorkTitleSim = how well the titles match (see STEP 4). If several artists have a work by that title, or none do, leave kWorkBackPropArtist "". This is a real, independent corroboration and — unlike the population counts — it VOTES. Example: workTitle "Death of the Virgin" returns only Rembrandt van Rijn → kWorkBackPropArtist = "Rembrandt van Rijn", kWorkTitleSim ≈ 0.95.
