...
export { priceAttrsOfComparable, priceAttrsOfLot, signatureClass, proofClass, detectCopyType, editionSizeOf, dimsCm, primaryProcess, isPoster, isObject, isDirectQualifier, PROCESSES } from "./price_attrs.js";
