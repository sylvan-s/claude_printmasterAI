...
export { priceAttrsOfComparable, priceAttrsOfLot, signatureClass, proofClass, detectCopyType, editionSizeOf, dimsCm, primaryProcess, isPoster, PROCESSES } from "./price_attrs.js";
