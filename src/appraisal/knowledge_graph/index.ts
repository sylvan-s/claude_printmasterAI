...
export { priceAttrsOfComparable, priceAttrsOfLot, signatureClass, proofClass, detectCopyType, editionSizeOf, dimsCm, primaryProcess, isPoster, isDirectQualifier, PROCESSES } from "./price_attrs.js";
