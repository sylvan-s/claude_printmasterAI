 ...
 * phase 5): the Stage 3a contribution waterfall on a log price axis, from the average sold print
 * to this lot's median, with Stage 3b's narration beside it. Bars are in GBP in the report and
